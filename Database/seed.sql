...
INSERT INTO mparam ("paramType", name, value, "createdOn", "createdBy") VALUES
  ...
  ('BULKING_CATEGORY', 'Mild', 1, now(), NULL),
  ('BULKING_CATEGORY', 'Moderate', 2, now(), NULL),
  ('BULKING_CATEGORY', 'Aggressive', 3, now(), NULL),
  ('GOAL_MODE', 'Cutting', 1, now(), NULL),
  ('GOAL_MODE', 'Bulking', 2, now(), NULL),
  ('GOAL_MODE', 'Maintain', 3, now(), NULL),
